...
struct ScanModeUpgradeView: View {    
    var body: some View {
        ...
        VStack {
            ...
            Text("Upgrade to iOS 16.1, once available, to use this new feature!")
                .multilineTextAlignment(.center)
                .padding(.horizontal)
...
struct ScanModeUpgradeView_Previews: PreviewProvider {
