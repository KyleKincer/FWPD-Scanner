...
struct WatchMapAnnotationView_Previews: PreviewProvider {
    static var previews: some View {
        WatchMapAnnotationView(viewModel: MainViewModel(), activity: Scanner.Activity(id: 1116, timestamp: "06/07/1998 - 01:01:01", nature: "Wild Kyle Appears", address: "5522 Old Dover Blvd", location: "Canterbury Green", controlNumber: "10AD43", longitude: -85.10719687273503, latitude: 41.13135945131842))
